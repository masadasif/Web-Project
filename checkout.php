    ...
    <div class="container">
       ...
       <?php 
          ...
          ?>
            ...
            <?php 
            $ip_add = getip();
            $get_user = "SELECT * FROM users WHERE ip = '$ip_add'";
	...
	<div class="row">
		<div class="paymentCont">
						<div class="headingWrap">
								...
								<p class="text-center">You can also play Offline (Cash On Delivery)</p>
						</div>
						...
						<div class="footerNavWrap clearfix">
                            <a href="cart.php">	<div class="btn btn-success pull-left btn-primary"><span class="glyphicon glyphicon-chevron-left"></span>BACK</div></a>
                            <a href="orders.php?user_id=<?php echo $user_id; ?>"><div class="btn btn-success pull-right btn-primary">Offline Payment<span class="glyphicon glyphicon-chevron-right"></span></div> </a>
						</div>
					</div>
